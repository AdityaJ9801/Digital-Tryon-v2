...
NUM_ITERATIONS = 2
TIMESTEPS = (2, 2)
ROOT_TRAIN = './data_small'  # ships with the repo; point at your own root to test against other data
...
def main():
    ...
    dataset = RealTryonDataset(root=ROOT_TRAIN, image_size=image_size)
